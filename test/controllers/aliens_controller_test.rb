...
class AliensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alien" do
    assert_difference('Alien.count') do
      post aliens_url, params: { alien: { address: @alien.address, latitude: @alien.latitude, longitude: @alien.longitude, name: @alien.name } }
    end
  ...
  test "should update alien" do
    patch alien_url(@alien), params: { alien: { address: @alien.address, latitude: @alien.latitude, longitude: @alien.longitude, name: @alien.name } }
